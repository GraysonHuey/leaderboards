    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-800 flex items-center justify-center px-4">
      <div className="max-w-4xl w-full">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl font-bold text-white mb-2">Welcome to BandScore!</h1>
          <p className="text-white/70 text-lg mb-4">Choose your instrument section to get started</p>
                ...
                {selectedSection === section.id && (
                  <div className="mt-3 flex justify-center">
                    <div className="bg-amber-400 rounded-full p-1">
                      <Check className="h-4 w-4 text-amber-900" />
                    </div>
                  </div>
                )}
              </div>
        ...
        <div className="text-center">
          <button
            ...
            className="bg-amber-500 hover:bg-amber-600 disabled:bg-amber-500/50 disabled:cursor-not-allowed text-white font-semibold py-4 px-8 rounded-xl transition-all duration-200 transform hover:scale-105 disabled:hover:scale-100 shadow-lg"
          >
            {loading ? (
